...
public class OpensearchScrollSearchIT extends OpensearchTestSupport {
		...
		return new RouteBuilder() {
			...
			public void configure() {
				from("direct:scroll-index")
						.to("opensearch-rest://opensearch?operation=Index&indexName=" + TWITTER_ES_INDEX_NAME);
				from("direct:scroll-search")
						.to("opensearch-rest://opensearch?operation=Search&indexName=" + TWITTER_ES_INDEX_NAME);

				from("direct:scroll-n-split-index")
						.to("opensearch-rest://opensearch?operation=Index&indexName=" + SPLIT_TWITTER_ES_INDEX_NAME);
