...
public class OpensearchSizeLimitIT extends OpensearchTestSupport {
		...
		return new RouteBuilder() {
			...
			public void configure() {
				...
				from("direct:searchWithSizeTwo")
						.to("opensearch-rest://opensearch?operation=Search&indexName=twitter&size=2");
				from("direct:searchFrom3")
						.to("opensearch-rest://opensearch?operation=Search&indexName=twitter&from=3");
			}
		};
	}
