...
public class OpensearchClusterIndexIT extends OpensearchTestSupport {
	@Test
		...
		return new RouteBuilder() {
			...
			public void configure() {
				from("direct:indexWithIpAndPort")
						.to("opensearch-rest://" + clusterName + "?operation=Index&indexName=twitter");
				from("direct:indexWithSniffer")
						.to("opensearch-rest://" + clusterName + "?operation=Index&indexName=twitter&enableSniffer=true");
			}
		};
	}
}
