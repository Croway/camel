...
public class OpensearchRestComponentVerifierExtension extends DefaultComponentVerifierExtension {

	public OpensearchRestComponentVerifierExtension() {
		this("opensearch-rest");
	}

	public OpensearchRestComponentVerifierExtension(String scheme) {
		super(scheme);
	}
