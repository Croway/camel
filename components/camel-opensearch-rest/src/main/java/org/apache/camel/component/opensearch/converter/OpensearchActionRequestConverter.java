...
public final class OpensearchActionRequestConverter {
	...
	private static UpdateRequest createUpdateRequest(Object document, Exchange exchange) {
		...
		return updateRequest
				.waitForActiveShards(
						exchange.getIn().getHeader(OpensearchConstants.PARAM_WAIT_FOR_ACTIVE_SHARDS, Integer.class))
	...
	public static IndexRequest toIndexRequest(Object document, Exchange exchange) {
		...
		if (indexRequest != null) {
			indexRequest.id(exchange.getIn().getHeader(OpensearchConstants.PARAM_INDEX_ID, String.class));
		}
	...
	public static UpdateRequest toUpdateRequest(Object document, Exchange exchange) {
		...
		if (updateRequest != null) {
			updateRequest.id(exchange.getIn().getHeader(OpensearchConstants.PARAM_INDEX_ID, String.class));
		}
	...
	public static GetRequest toGetRequest(Object document, Exchange exchange) {
		...
		if (document instanceof String) {
			return new GetRequest(exchange.getIn().getHeader(OpensearchConstants.PARAM_INDEX_NAME, String.class))
					.id((String) document);
		}
		return null;
	}
	...
	public static DeleteRequest toDeleteRequest(Object document, Exchange exchange) {
		...
		if (document instanceof String) {
			return new DeleteRequest().index(exchange.getIn().getHeader(OpensearchConstants.PARAM_INDEX_NAME, String.class))
					.id((String) document);
		}
		return null;
	}
	...
	public static DeleteIndexRequest toDeleteIndexRequest(Object document, Exchange exchange) {
		...
		if (document instanceof String) {
			String index = exchange.getIn().getHeader(OpensearchConstants.PARAM_INDEX_NAME, String.class);
