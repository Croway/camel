 ...
 */
package org.apache.camel.component.os;
...
class OpensearchProducer extends DefaultAsyncProducer {
			...
			switch (operation) {
				...
				case Search: {
					...
					if (useScroll) {
						...
						onComplete(
								new OpenSearchAsyncClient(transport).search(searchRequestBuilder.build(), documentClass)
	...
	private static class ActionContext {
		...
		OpenSearchTransport getTransport() {
			return transport;
		}
